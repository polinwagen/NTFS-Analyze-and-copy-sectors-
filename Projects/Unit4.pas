...
ShowMessage(' опирование каталога "'+directory+'" и его содержимого успешно завершено!');
end;
...
procedure ThrCopy.CopySector;    //копирование по секторам
var
...
begin
        ...
        I:=0;
      Form12.Memo1.Lines.Add(' опирование файла:'+names);
     ...
     FileClose(iFileHandle1);
      ...
      m:=I div 512;
       Form12.Memo1.Lines.Add('—копирован сектор:'+inttostr(m));
